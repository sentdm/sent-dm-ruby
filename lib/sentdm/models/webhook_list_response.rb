  ...
  module Models
    ...
    class WebhookListResponse < Sentdm::Internal::Type::BaseModel
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #
        #   @param webhooks [Array<Sentdm::Models::WebhookListResponse::Data::Webhook>] The webhooks on this page.
        ...
        class Pagination < Sentdm::Internal::Type::BaseModel
          ...
          #   Pagination metadata for list responses
          #
          #   @param cursors [Sentdm::Models::WebhookListResponse::Data::Pagination::Cursors, nil] Cursor-based pagination. Never populated — see Cursors.
          #
        ...
        class Webhook < Sentdm::Internal::Type::BaseModel
          ...
          #   {Sentdm::Models::WebhookListResponse::Data::Webhook} for more details.
          #
          #   @param id [String]
          #
