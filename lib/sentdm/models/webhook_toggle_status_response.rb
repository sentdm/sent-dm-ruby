...
module Sentdm
  module Models
    ...
    class WebhookToggleStatusResponse < Sentdm::Internal::Type::BaseModel
      # @!attribute data
      #   The response data (null if error)
      #
      #   @return [Sentdm::Models::WebhookToggleStatusResponse::Data, nil]
      optional :data, -> { Sentdm::Models::WebhookToggleStatusResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::WebhookToggleStatusResponse::Error, nil]
      optional :error, -> { Sentdm::Models::WebhookToggleStatusResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::WebhookToggleStatusResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::WebhookToggleStatusResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::WebhookToggleStatusResponse::Data, nil] The response data (null if error)
      #
      #   @param error [Sentdm::Models::WebhookToggleStatusResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::WebhookToggleStatusResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::WebhookToggleStatusResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        # @!method initialize(id: nil, consecutive_failures: nil, created_at: nil, customer_id: nil, display_name: nil, endpoint_url: nil, event_filters: nil, event_types: nil, is_active: nil, last_delivery_attempt_at: nil, last_successful_delivery_at: nil, retry_count: nil, signing_secret: nil, timeout_seconds: nil, updated_at: nil)
        #   Some parameter documentations has been truncated, see
        #   {Sentdm::Models::WebhookToggleStatusResponse::Data} for more details.
        #
        #   The response data (null if error)
        #
        #   @param id [String]
      ...
      # @see Sentdm::Models::WebhookToggleStatusResponse#error
      ...
      # @see Sentdm::Models::WebhookToggleStatusResponse#meta
