...
module Sentdm
  module Models
    ...
    class ProfileCreateResponse < Sentdm::Internal::Type::BaseModel
      ...
      #
      #   @return [Sentdm::Models::ProfileCreateResponse::Data, nil]
      optional :data, -> { Sentdm::Models::ProfileCreateResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::ProfileCreateResponse::Error, nil]
      optional :error, -> { Sentdm::Models::ProfileCreateResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::ProfileCreateResponse::Meta, nil]
      ...
      #
      #   @param data [Sentdm::Models::ProfileCreateResponse::Data, nil] Detailed profile response for v3 API
      #
      #   @param error [Sentdm::Models::ProfileCreateResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::ProfileCreateResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::ProfileCreateResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #
        #   @return [Sentdm::Models::ProfileCreateResponse::Data::BillingContact, nil]
        optional :billing_contact, -> { Sentdm::Models::ProfileCreateResponse::Data::BillingContact }, nil?: true
        ...
        #
        #   @return [Sentdm::Models::ProfileCreateResponse::Data::Brand, nil]
        optional :brand, -> { Sentdm::Models::ProfileCreateResponse::Data::Brand }, nil?: true
        ...
        #   {Sentdm::Models::ProfileCreateResponse::Data} for more details.
        #
        #   Detailed profile response for v3 API
        #
        ...
        #
        #   @param billing_contact [Sentdm::Models::ProfileCreateResponse::Data::BillingContact, nil] Billing contact info returned in profile responses
        #
        #   @param billing_model [String] Billing model: profile, organization, or profile_and_organization
        #
        #   @param brand [Sentdm::Models::ProfileCreateResponse::Data::Brand, nil] Brand response with nested contact, business, and compliance sections — mirrors
        #
        ...
        # @see Sentdm::Models::ProfileCreateResponse::Data#billing_contact
        ...
        # @see Sentdm::Models::ProfileCreateResponse::Data#brand
        class Brand < Sentdm::Internal::Type::BaseModel
          ...
          #
          #   @return [Sentdm::Models::ProfileCreateResponse::Data::Brand::Business, nil]
          optional :business, -> { Sentdm::Models::ProfileCreateResponse::Data::Brand::Business }, nil?: true

          # @!attribute compliance
          #   Compliance and TCR-related information
          #
          #   @return [Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance, nil]
          optional :compliance, -> { Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance }, nil?: true

          # @!attribute contact
          #   Contact information for the brand
          #
          #   @return [Sentdm::Models::ProfileCreateResponse::Data::Brand::Contact, nil]
          optional :contact, -> { Sentdm::Models::ProfileCreateResponse::Data::Brand::Contact }, nil?: true
          ...
          #
          #   @return [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::IdentityStatus, nil]
          optional :identity_status,
                   enum: -> { Sentdm::Models::ProfileCreateResponse::Data::Brand::IdentityStatus },
                   nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::Status, nil]
          optional :status, enum: -> { Sentdm::Models::ProfileCreateResponse::Data::Brand::Status }, nil?: true
          ...
          #
          #   @param business [Sentdm::Models::ProfileCreateResponse::Data::Brand::Business, nil] Business details and address information
          #
          #   @param compliance [Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance, nil] Compliance and TCR-related information
          #
          #   @param contact [Sentdm::Models::ProfileCreateResponse::Data::Brand::Contact, nil] Contact information for the brand
          #
          #   @param created_at [Time] When the brand was created
          #
          #   @param csp_id [String, nil] CSP (Campaign Service Provider) ID
          #
          #   @param identity_status [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::IdentityStatus, nil]
          #
          #   @param is_inherited [Boolean] Whether this brand is inherited from the parent organization
          #
          #   @param status [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::Status, nil]
          #
          ...
          # @see Sentdm::Models::ProfileCreateResponse::Data::Brand#business
          ...
          # @see Sentdm::Models::ProfileCreateResponse::Data::Brand#compliance
          class Compliance < Sentdm::Internal::Type::BaseModel
            # @!attribute brand_relationship
            #
            #   @return [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::BrandRelationship, nil]
            ...
            #
            #   @return [Array<Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::DestinationCountry>, nil]
            ...
            # @!attribute vertical
            #
            #   @return [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::Vertical, nil]
            optional :vertical,
            ...
            #   Compliance and TCR-related information
            #
            #   @param brand_relationship [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::BrandRelationship, nil]
            #
            #   @param destination_countries [Array<Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::DestinationCountry>] List of destination countries for messaging
            #
            ...
            #
            #   @param vertical [Symbol, Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::Vertical, nil]

            # @see Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance#brand_relationship
            ...
            # @see Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance#vertical
            module Vertical
              extend Sentdm::Internal::Type::Enum
          ...
          # @see Sentdm::Models::ProfileCreateResponse::Data::Brand#contact
          ...
          # @see Sentdm::Models::ProfileCreateResponse::Data::Brand#identity_status
          ...
          # @see Sentdm::Models::ProfileCreateResponse::Data::Brand#status
          module Status
            extend Sentdm::Internal::Type::Enum
      ...
      # @see Sentdm::Models::ProfileCreateResponse#error
      ...
      # @see Sentdm::Models::ProfileCreateResponse#meta
