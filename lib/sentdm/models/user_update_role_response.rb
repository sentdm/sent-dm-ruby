...
module Sentdm
  module Models
    ...
    class UserUpdateRoleResponse < Sentdm::Internal::Type::BaseModel
      ...
      #
      #   @return [Sentdm::Models::UserUpdateRoleResponse::Data, nil]
      optional :data, -> { Sentdm::Models::UserUpdateRoleResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::UserUpdateRoleResponse::Error, nil]
      optional :error, -> { Sentdm::Models::UserUpdateRoleResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::UserUpdateRoleResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::UserUpdateRoleResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::UserUpdateRoleResponse::Data, nil] User response for v3 API
      #
      #   @param error [Sentdm::Models::UserUpdateRoleResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::UserUpdateRoleResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::UserUpdateRoleResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #   {Sentdm::Models::UserUpdateRoleResponse::Data} for more details.
        #
        #   User response for v3 API
        #
      ...
      # @see Sentdm::Models::UserUpdateRoleResponse#error
      ...
      # @see Sentdm::Models::UserUpdateRoleResponse#meta
