...
module Sentdm
  module Models
    ...
    class WebhookRetrieveResponse < Sentdm::Internal::Type::BaseModel
      # @!attribute data
      #   The response data (null if error)
      #
      #   @return [Sentdm::Models::WebhookRetrieveResponse::Data, nil]
      optional :data, -> { Sentdm::Models::WebhookRetrieveResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::WebhookRetrieveResponse::Error, nil]
      optional :error, -> { Sentdm::Models::WebhookRetrieveResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::WebhookRetrieveResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::WebhookRetrieveResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::WebhookRetrieveResponse::Data, nil] The response data (null if error)
      #
      #   @param error [Sentdm::Models::WebhookRetrieveResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::WebhookRetrieveResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::WebhookRetrieveResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #   {Sentdm::Models::WebhookRetrieveResponse::Data} for more details.
        #
        #   The response data (null if error)
        #
        #   @param id [String]
      ...
      # @see Sentdm::Models::WebhookRetrieveResponse#error
      ...
      # @see Sentdm::Models::WebhookRetrieveResponse#meta
