...
module Sentdm
  module Models
    class TemplateDefinition < Sentdm::Internal::Type::BaseModel
      ...
      #   buttons
      #
      #   @param body [Sentdm::Models::TemplateDefinition::Body] Body section of a message template with channel-specific content
      #
      #   @param authentication_config [Sentdm::Models::TemplateDefinition::AuthenticationConfig, nil] Configuration for AUTHENTICATION category templates
      #
      ...
      #
      #   @param footer [Sentdm::Models::TemplateDefinition::Footer, nil] Footer section of a message template
      #
      #   @param header [Sentdm::Models::TemplateDefinition::Header, nil] Header section of a message template
