...
module Sentdm
  module Models
    ...
    class ConversationListResponse < Sentdm::Internal::Type::BaseModel
      ...
      #
      #   @return [Sentdm::Models::ConversationListResponse::Data, nil]
      optional :data, -> { Sentdm::Models::ConversationListResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::ConversationListResponse::Error, nil]
      optional :error, -> { Sentdm::Models::ConversationListResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::ConversationListResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::ConversationListResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::ConversationListResponse::Data, nil] A paginated list of messages — used by both conversation read endpoints.
      #
      #   @param error [Sentdm::Models::ConversationListResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::ConversationListResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::ConversationListResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        # @!attribute messages
        #   The messages on this page.
        #
        #   @return [Array<Sentdm::Models::ConversationListResponse::Data::Message>, nil]
        optional :messages,
                 -> { Sentdm::Internal::Type::ArrayOf[Sentdm::Models::ConversationListResponse::Data::Message] }

        # @!attribute pagination
        #   Pagination metadata for list responses
        #
        #   @return [Sentdm::Models::ConversationListResponse::Data::Pagination, nil]
        optional :pagination, -> { Sentdm::Models::ConversationListResponse::Data::Pagination }

        # @!method initialize(messages: nil, pagination: nil)
        #   A paginated list of messages — used by both conversation read endpoints.
        #
        #   @param messages [Array<Sentdm::Models::ConversationListResponse::Data::Message>] The messages on this page.
        #
        #   @param pagination [Sentdm::Models::ConversationListResponse::Data::Pagination] Pagination metadata for list responses
        ...
        class Message < Sentdm::Internal::Type::BaseModel
          ...
          # @!attribute events
          #
          #   @return [Array<Sentdm::Models::ConversationListResponse::Data::Message::Event>, nil]
          optional :events,
                   -> { Sentdm::Internal::Type::ArrayOf[Sentdm::Models::ConversationListResponse::Data::Message::Event] },
                   nil?: true
          ...
          #
          #   @return [Sentdm::Models::ConversationListResponse::Data::Message::MessageBody, nil]
          optional :message_body,
                   -> { Sentdm::Models::ConversationListResponse::Data::Message::MessageBody },
                   nil?: true
          ...
          #   {Sentdm::Models::ConversationListResponse::Data::Message} for more details.
          #
          ...
          #
          #   @param events [Array<Sentdm::Models::ConversationListResponse::Data::Message::Event>, nil]
          #
          #   @param message_body [Sentdm::Models::ConversationListResponse::Data::Message::MessageBody, nil] Structured message body format for database storage.
          #
          #   @param phone [String]
          #
          ...
          # @see Sentdm::Models::ConversationListResponse::Data::Message#message_body
          class MessageBody < Sentdm::Internal::Type::BaseModel
            # @!attribute buttons
            #
            #   @return [Array<Sentdm::Models::ConversationListResponse::Data::Message::MessageBody::Button>, nil]
            optional :buttons,
                     -> { Sentdm::Internal::Type::ArrayOf[Sentdm::Models::ConversationListResponse::Data::Message::MessageBody::Button] },
                     nil?: true
            ...
            #   components (header, body, footer, buttons).
            #
            #   @param buttons [Array<Sentdm::Models::ConversationListResponse::Data::Message::MessageBody::Button>, nil]
        ...
        # @see Sentdm::Models::ConversationListResponse::Data#pagination
        class Pagination < Sentdm::Internal::Type::BaseModel
          ...
          #
          #   @return [Sentdm::Models::ConversationListResponse::Data::Pagination::Cursors, nil]
          optional :cursors, -> { Sentdm::Models::ConversationListResponse::Data::Pagination::Cursors }, nil?: true
          ...
          #   Pagination metadata for list responses
          #
          #   @param cursors [Sentdm::Models::ConversationListResponse::Data::Pagination::Cursors, nil] Cursor-based pagination. Never populated — see Cursors.
          #
          ...
          # @deprecated
          #
          # @see Sentdm::Models::ConversationListResponse::Data::Pagination#cursors
      ...
      # @see Sentdm::Models::ConversationListResponse#error
      ...
      # @see Sentdm::Models::ConversationListResponse#meta
