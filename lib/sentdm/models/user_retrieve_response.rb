...
module Sentdm
  module Models
    ...
    class UserRetrieveResponse < Sentdm::Internal::Type::BaseModel
      ...
      #
      #   @return [Sentdm::Models::UserRetrieveResponse::Data, nil]
      optional :data, -> { Sentdm::Models::UserRetrieveResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::UserRetrieveResponse::Error, nil]
      optional :error, -> { Sentdm::Models::UserRetrieveResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::UserRetrieveResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::UserRetrieveResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::UserRetrieveResponse::Data, nil] User response for v3 API
      #
      #   @param error [Sentdm::Models::UserRetrieveResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::UserRetrieveResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::UserRetrieveResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #   {Sentdm::Models::UserRetrieveResponse::Data} for more details.
        #
        #   User response for v3 API
        #
      ...
      # @see Sentdm::Models::UserRetrieveResponse#error
      ...
      # @see Sentdm::Models::UserRetrieveResponse#meta
