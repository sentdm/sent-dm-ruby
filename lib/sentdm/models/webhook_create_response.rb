...
module Sentdm
  module Models
    ...
    class WebhookCreateResponse < Sentdm::Internal::Type::BaseModel
      # @!attribute data
      #   The response data (null if error)
      #
      #   @return [Sentdm::Models::WebhookCreateResponse::Data, nil]
      optional :data, -> { Sentdm::Models::WebhookCreateResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::WebhookCreateResponse::Error, nil]
      optional :error, -> { Sentdm::Models::WebhookCreateResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::WebhookCreateResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::WebhookCreateResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::WebhookCreateResponse::Data, nil] The response data (null if error)
      #
      #   @param error [Sentdm::Models::WebhookCreateResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::WebhookCreateResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::WebhookCreateResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #   {Sentdm::Models::WebhookCreateResponse::Data} for more details.
        #
        #   The response data (null if error)
        #
        #   @param id [String]
      ...
      # @see Sentdm::Models::WebhookCreateResponse#error
      ...
      # @see Sentdm::Models::WebhookCreateResponse#meta
