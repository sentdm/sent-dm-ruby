...
module Sentdm
  module Models
    ...
    class UserInviteResponse < Sentdm::Internal::Type::BaseModel
      ...
      #
      #   @return [Sentdm::Models::UserInviteResponse::Data, nil]
      optional :data, -> { Sentdm::Models::UserInviteResponse::Data }, nil?: true

      # @!attribute error
      #   Error information
      #
      #   @return [Sentdm::Models::UserInviteResponse::Error, nil]
      optional :error, -> { Sentdm::Models::UserInviteResponse::Error }, nil?: true

      # @!attribute meta
      #   Request and response metadata
      #
      #   @return [Sentdm::Models::UserInviteResponse::Meta, nil]
      optional :meta, -> { Sentdm::Models::UserInviteResponse::Meta }
      ...
      #
      #   @param data [Sentdm::Models::UserInviteResponse::Data, nil] User response for v3 API
      #
      #   @param error [Sentdm::Models::UserInviteResponse::Error, nil] Error information
      #
      #   @param meta [Sentdm::Models::UserInviteResponse::Meta] Request and response metadata
      #
      #   @param success [Boolean] Indicates whether the request was successful

      # @see Sentdm::Models::UserInviteResponse#data
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        #   {Sentdm::Models::UserInviteResponse::Data} for more details.
        #
        #   User response for v3 API
        #
      ...
      # @see Sentdm::Models::UserInviteResponse#error
      ...
      # @see Sentdm::Models::UserInviteResponse#meta
