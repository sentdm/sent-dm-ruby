  ...
  module Errors
    ...
    class APIStatusError < Sentdm::Errors::APIError
      ...
      def self.for(url:, status:, headers:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          Sentdm::Errors::BadRequestError.new(**kwargs)
        in 401
          Sentdm::Errors::AuthenticationError.new(**kwargs)
        in 403
          Sentdm::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          Sentdm::Errors::NotFoundError.new(**kwargs)
        in 409
          Sentdm::Errors::ConflictError.new(**kwargs)
        in 422
          Sentdm::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          Sentdm::Errors::RateLimitError.new(**kwargs)
        in (500..)
          Sentdm::Errors::InternalServerError.new(**kwargs)
        else
          Sentdm::Errors::APIStatusError.new(**kwargs)
        end
      end
