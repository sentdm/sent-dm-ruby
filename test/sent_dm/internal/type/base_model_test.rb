...
class SentDm::Test::PrimitiveModelTest < Minitest::Test
  A = SentDm::Internal::Type::ArrayOf[-> { Integer }]
  H = SentDm::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < SentDm::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => SentDm::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [SentDm::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [SentDm::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [SentDm::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = SentDm::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        SentDm::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [SentDm::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [SentDm::Internal::Type::Boolean, true] => true,
      [SentDm::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => SentDm::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        SentDm::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = SentDm::Internal::Type::Converter.new_coerce_state
      SentDm::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        SentDm::Internal::Type::Converter.dump(target, input, state: state)
...
class SentDm::Test::EnumModelTest < Minitest::Test
  class E0
    include SentDm::Internal::Type::Enum
...
class SentDm::Test::CollectionModelTest < Minitest::Test
  A1 = SentDm::Internal::Type::ArrayOf[-> { Integer }]
  H1 = SentDm::Internal::Type::HashOf[Integer]

  A2 = SentDm::Internal::Type::ArrayOf[H1]
  H2 = SentDm::Internal::Type::HashOf[-> { A1 }]

  A3 = SentDm::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = SentDm::Internal::Type::HashOf[Integer, nil?: true]
...
class SentDm::Test::BaseModelTest < Minitest::Test
  class M1 < SentDm::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < SentDm::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < SentDm::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, SentDm::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = SentDm::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = SentDm::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(SentDm::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue SentDm::Errors::ConversionError => e
...
class SentDm::Test::UnionTest < Minitest::Test
  class U0
    include SentDm::Internal::Type::Union
  ...
  class M2 < SentDm::Internal::Type::BaseModel
  ...
  class M4 < SentDm::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, SentDm::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < SentDm::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, SentDm::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class SentDm::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include SentDm::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [SentDm::Internal::Type::Unknown, SentDm::Internal::Type::Unknown] => true,
      [SentDm::Internal::Type::Boolean, SentDm::Internal::Type::Boolean] => true,
      [SentDm::Internal::Type::Unknown, SentDm::Internal::Type::Boolean] => false,
...
class SentDm::Test::MetaInfoTest < Minitest::Test
  A1 = SentDm::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = SentDm::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
