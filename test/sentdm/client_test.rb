...
class SentdmTest < Minitest::Test
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/v3/messages").to_return_json(
      status: 500,
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: Sentdm::Client::MAX_REDIRECTS) do
