...
class Sentdm::Test::Resources::ContactsTest < Sentdm::Test::ResourceTest
  ...
  def test_retrieve_message_summary
    ...
    assert_pattern do
      response => Sentdm::Models::ContactRetrieveMessageSummaryResponse
    end

    assert_pattern do
      response => {
        data: Sentdm::Models::ContactRetrieveMessageSummaryResponse::Data | nil,
        error: Sentdm::Models::ContactRetrieveMessageSummaryResponse::Error | nil,
        meta: Sentdm::Models::ContactRetrieveMessageSummaryResponse::Meta | nil,
        success: Sentdm::Internal::Type::Boolean | nil
      }
    end
  end
