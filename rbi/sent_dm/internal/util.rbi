      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            SentDm::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: SentDm::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: SentDm::Internal::Util::ParsedUri,
            rhs: SentDm::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[SentDm::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(SentDm::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
