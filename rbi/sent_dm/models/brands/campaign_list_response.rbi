  ...
  module Models
    module Brands
      class CampaignListResponse < SentDm::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(T::Array[SentDm::Brands::TcrCampaignWithUseCases]))
        end
        attr_accessor :data
        ...
        sig do
          params(
            data:
              T.nilable(
                T::Array[SentDm::Brands::TcrCampaignWithUseCases::OrHash]
              ),
        ...
        sig do
          override.returns(
            {
              data:
                T.nilable(T::Array[SentDm::Brands::TcrCampaignWithUseCases]),
