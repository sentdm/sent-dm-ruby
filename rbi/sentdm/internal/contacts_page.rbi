  ...
  module Internal
    class ContactsPage
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        sig { params(contacts: T::Array[T.anything]).void }
        ...
        sig do
          params(
            contacts: T::Array[T.anything],
            pagination: Data::Pagination::OrHash
          ).returns(T.attached_class)
        end
        def self.new(contacts: nil, pagination: nil)
        end

        sig do
          override.returns(
            { contacts: T::Array[T.anything], pagination: Data::Pagination }
          )
        end
        def to_hash
        end
