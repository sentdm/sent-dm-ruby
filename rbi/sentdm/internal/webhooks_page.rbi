  ...
  module Internal
    class WebhooksPage
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        ...
        sig { params(webhooks: T::Array[T.anything]).void }
        attr_writer :webhooks

        sig do
          params(
            pagination: Data::Pagination::OrHash,
            webhooks: T::Array[T.anything]
          ).returns(T.attached_class)
        end
        def self.new(pagination: nil, webhooks: nil)
        end

        sig do
          override.returns(
            { pagination: Data::Pagination, webhooks: T::Array[T.anything] }
          )
        end
        def to_hash
        end
