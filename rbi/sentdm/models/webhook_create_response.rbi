...
module Sentdm
  module Models
    class WebhookCreateResponse < Sentdm::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Sentdm::Models::WebhookCreateResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: T.nilable(Sentdm::Models::WebhookCreateResponse::Data::OrHash)
        ).void
      end
      attr_writer :data

      # Error information
      sig { returns(T.nilable(Sentdm::Models::WebhookCreateResponse::Error)) }
      attr_reader :error

      sig do
        params(
          error: T.nilable(Sentdm::Models::WebhookCreateResponse::Error::OrHash)
        ).void
      end
      attr_writer :error

      # Request and response metadata
      sig { returns(T.nilable(Sentdm::Models::WebhookCreateResponse::Meta)) }
      attr_reader :meta

      sig do
        params(meta: Sentdm::Models::WebhookCreateResponse::Meta::OrHash).void
      end
      attr_writer :meta
      ...
      sig do
        params(
          data: T.nilable(Sentdm::Models::WebhookCreateResponse::Data::OrHash),
          error:
            T.nilable(Sentdm::Models::WebhookCreateResponse::Error::OrHash),
          meta: Sentdm::Models::WebhookCreateResponse::Meta::OrHash,
          success: T::Boolean
      ...
      sig do
        override.returns(
          {
            data: T.nilable(Sentdm::Models::WebhookCreateResponse::Data),
            error: T.nilable(Sentdm::Models::WebhookCreateResponse::Error),
            meta: Sentdm::Models::WebhookCreateResponse::Meta,
            success: T::Boolean
          }
        )
      end
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookCreateResponse::Data,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Error < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookCreateResponse::Error,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Meta < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookCreateResponse::Meta,
              Sentdm::Internal::AnyHash
            )
          end
