...
module Sentdm
  module Models
    class WebhookRetrieveResponse < Sentdm::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Sentdm::Models::WebhookRetrieveResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: T.nilable(Sentdm::Models::WebhookRetrieveResponse::Data::OrHash)
        ).void
      end
      attr_writer :data

      # Error information
      sig { returns(T.nilable(Sentdm::Models::WebhookRetrieveResponse::Error)) }
      attr_reader :error

      sig do
        params(
          error:
            T.nilable(Sentdm::Models::WebhookRetrieveResponse::Error::OrHash)
        ).void
      end
      attr_writer :error

      # Request and response metadata
      sig { returns(T.nilable(Sentdm::Models::WebhookRetrieveResponse::Meta)) }
      attr_reader :meta

      sig do
        params(meta: Sentdm::Models::WebhookRetrieveResponse::Meta::OrHash).void
      end
      attr_writer :meta
      ...
      sig do
        params(
          data:
            T.nilable(Sentdm::Models::WebhookRetrieveResponse::Data::OrHash),
          error:
            T.nilable(Sentdm::Models::WebhookRetrieveResponse::Error::OrHash),
          meta: Sentdm::Models::WebhookRetrieveResponse::Meta::OrHash,
          success: T::Boolean
      ...
      sig do
        override.returns(
          {
            data: T.nilable(Sentdm::Models::WebhookRetrieveResponse::Data),
            error: T.nilable(Sentdm::Models::WebhookRetrieveResponse::Error),
            meta: Sentdm::Models::WebhookRetrieveResponse::Meta,
            success: T::Boolean
          }
        )
      end
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookRetrieveResponse::Data,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Error < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookRetrieveResponse::Error,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Meta < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookRetrieveResponse::Meta,
              Sentdm::Internal::AnyHash
            )
          end
