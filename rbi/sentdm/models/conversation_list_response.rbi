  ...
  module Models
    class ConversationListResponse < Sentdm::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Sentdm::Models::ConversationListResponse,
            Sentdm::Internal::AnyHash
          )
        end

      # A paginated list of messages — used by both conversation read endpoints.
      sig { returns(T.nilable(Sentdm::Models::ConversationListResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data:
            T.nilable(Sentdm::Models::ConversationListResponse::Data::OrHash)
        ).void
      end
      attr_writer :data
      ...
      # Error information
      sig do
        returns(T.nilable(Sentdm::Models::ConversationListResponse::Error))
      end
      attr_reader :error
      ...
      sig do
        params(
          error:
            T.nilable(Sentdm::Models::ConversationListResponse::Error::OrHash)
        ).void
      end
      attr_writer :error

      # Request and response metadata
      sig { returns(T.nilable(Sentdm::Models::ConversationListResponse::Meta)) }
      attr_reader :meta

      sig do
        params(
          meta: Sentdm::Models::ConversationListResponse::Meta::OrHash
        ).void
      end
      attr_writer :meta
      ...
      sig do
        override.returns(
          {
            data: T.nilable(Sentdm::Models::ConversationListResponse::Data),
            error: T.nilable(Sentdm::Models::ConversationListResponse::Error),
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::ConversationListResponse::Data,
              Sentdm::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Sentdm::Models::ConversationListResponse::Data::Message]
            )
          )
        end
        ...
        sig do
          params(
            messages:
              T::Array[
                Sentdm::Models::ConversationListResponse::Data::Message::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            pagination:
              Sentdm::Models::ConversationListResponse::Data::Pagination::OrHash
          ).void
        end
          ...
          override.returns(
            {
              messages:
                T::Array[
                  Sentdm::Models::ConversationListResponse::Data::Message
                ],
              pagination:
                Sentdm::Models::ConversationListResponse::Data::Pagination
            }
        ...
        class Message < Sentdm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Sentdm::Models::ConversationListResponse::Data::Message::Event
                ]
              )
            )
          end
          ...
          sig do
            params(
              message_body:
                T.nilable(
                  Sentdm::Models::ConversationListResponse::Data::Message::MessageBody::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              ...
              events:
                T.nilable(
                  T::Array[
                    Sentdm::Models::ConversationListResponse::Data::Message::Event::OrHash
                  ]
                ),
              message_body:
                T.nilable(
          ...
          class MessageBody < Sentdm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Sentdm::Models::ConversationListResponse::Data::Message::MessageBody::Button
                  ]
                )
              )
            end
            ...
            sig do
              params(
                buttons:
                  T.nilable(
                    T::Array[
                      Sentdm::Models::ConversationListResponse::Data::Message::MessageBody::Button::OrHash
                    ]
                  ),
                content: String,
        ...
        class Pagination < Sentdm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Sentdm::Models::ConversationListResponse::Data::Pagination::Cursors
              )
            )
          end
          attr_reader :cursors
          ...
          sig do
            params(
              cursors:
                T.nilable(
                  Sentdm::Models::ConversationListResponse::Data::Pagination::Cursors::OrHash
                )
            ).void
          end
          attr_writer :cursors
      ...
      class Error < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::ConversationListResponse::Error,
              Sentdm::Internal::AnyHash
            )
          end
