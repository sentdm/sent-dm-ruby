...
module Sentdm
  module Models
    class WebhookToggleStatusResponse < Sentdm::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Sentdm::Models::WebhookToggleStatusResponse::Data))
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T.nilable(Sentdm::Models::WebhookToggleStatusResponse::Data::OrHash)
        ).void
      end
      attr_writer :data
      ...
      # Error information
      sig do
        returns(T.nilable(Sentdm::Models::WebhookToggleStatusResponse::Error))
      end
      attr_reader :error
      ...
      sig do
        params(
          error:
            T.nilable(
              Sentdm::Models::WebhookToggleStatusResponse::Error::OrHash
            )
        ).void
      end
      attr_writer :error
      ...
      sig do
        returns(T.nilable(Sentdm::Models::WebhookToggleStatusResponse::Meta))
      end
      attr_reader :meta

      sig do
        params(
          meta: Sentdm::Models::WebhookToggleStatusResponse::Meta::OrHash
        ).void
      end
      attr_writer :meta
      ...
      sig do
        params(
          data:
            T.nilable(
              Sentdm::Models::WebhookToggleStatusResponse::Data::OrHash
            ),
          error:
            T.nilable(
              Sentdm::Models::WebhookToggleStatusResponse::Error::OrHash
      ...
      sig do
        override.returns(
          {
            data: T.nilable(Sentdm::Models::WebhookToggleStatusResponse::Data),
            error:
              T.nilable(Sentdm::Models::WebhookToggleStatusResponse::Error),
            meta: Sentdm::Models::WebhookToggleStatusResponse::Meta,
            success: T::Boolean
          }
        )
      end
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookToggleStatusResponse::Data,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Error < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookToggleStatusResponse::Error,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Meta < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::WebhookToggleStatusResponse::Meta,
              Sentdm::Internal::AnyHash
            )
          end
