...
module Sentdm
  module Models
    class ContactUpdateResponse < Sentdm::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Sentdm::Models::ContactUpdateResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: T.nilable(Sentdm::Models::ContactUpdateResponse::Data::OrHash)
        ).void
      end
      attr_writer :data

      # Error information
      sig { returns(T.nilable(Sentdm::Models::ContactUpdateResponse::Error)) }
      attr_reader :error

      sig do
        params(
          error: T.nilable(Sentdm::Models::ContactUpdateResponse::Error::OrHash)
        ).void
      end
      attr_writer :error

      # Request and response metadata
      sig { returns(T.nilable(Sentdm::Models::ContactUpdateResponse::Meta)) }
      attr_reader :meta

      sig do
        params(meta: Sentdm::Models::ContactUpdateResponse::Meta::OrHash).void
      end
      attr_writer :meta
      ...
      sig do
        params(
          data: T.nilable(Sentdm::Models::ContactUpdateResponse::Data::OrHash),
          error:
            T.nilable(Sentdm::Models::ContactUpdateResponse::Error::OrHash),
          meta: Sentdm::Models::ContactUpdateResponse::Meta::OrHash,
          success: T::Boolean
      ...
      sig do
        override.returns(
          {
            data: T.nilable(Sentdm::Models::ContactUpdateResponse::Data),
            error: T.nilable(Sentdm::Models::ContactUpdateResponse::Error),
            meta: Sentdm::Models::ContactUpdateResponse::Meta,
            success: T::Boolean
          }
        )
      end
      ...
      class Data < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::ContactUpdateResponse::Data,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Error < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::ContactUpdateResponse::Error,
              Sentdm::Internal::AnyHash
            )
          end
      ...
      class Meta < Sentdm::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Sentdm::Models::ContactUpdateResponse::Meta,
              Sentdm::Internal::AnyHash
            )
          end
