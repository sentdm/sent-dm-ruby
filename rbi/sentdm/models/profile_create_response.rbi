        ...
        class Brand < Sentdm::Internal::Type::BaseModel
          ...
          class Compliance < Sentdm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::BrandRelationship::TaggedSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::DestinationCountry
                  ]
                )
              )
            end
            ...
            sig do
              params(
                destination_countries:
                  T::Array[
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::DestinationCountry::OrHash
                  ]
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::Vertical::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                brand_relationship:
                  T.nilable(
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::BrandRelationship::OrSymbol
                  ),
                destination_countries:
                  T::Array[
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::DestinationCountry::OrHash
                ...
                vertical:
                  T.nilable(
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::Vertical::OrSymbol
                  )
              ).returns(T.attached_class)
            end
            def self.new(
            ...
            module BrandRelationship
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::BrandRelationship
                  )
                end
            ...
            module Vertical
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Sentdm::Models::ProfileCreateResponse::Data::Brand::Compliance::Vertical
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
