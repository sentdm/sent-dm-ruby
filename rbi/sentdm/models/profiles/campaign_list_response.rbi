      ...
      class CampaignListResponse < Sentdm::Internal::Type::BaseModel
        ...
        class Data < Sentdm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Sentdm::Models::Profiles::CampaignListResponse::Data::SharingStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              sharing_status:
                T.nilable(
                  Sentdm::Models::Profiles::CampaignListResponse::Data::SharingStatus::OrSymbol
                ),
              status:
                T.nilable(
          ...
          module SharingStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Sentdm::Models::Profiles::CampaignListResponse::Data::SharingStatus
                )
              end
          ...
          class UseCase < Sentdm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Sentdm::Models::Profiles::CampaignListResponse::Data::UseCase::MessagingUseCaseUs::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                messaging_use_case_us:
                  Sentdm::Models::Profiles::CampaignListResponse::Data::UseCase::MessagingUseCaseUs::OrSymbol
              ).void
            end
            ...
            module MessagingUseCaseUs
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Sentdm::Models::Profiles::CampaignListResponse::Data::UseCase::MessagingUseCaseUs
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
