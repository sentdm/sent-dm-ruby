  ...
  module Models
    module Profiles
      class CampaignCreateResponse < Sentdm::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Sentdm::Models::Profiles::CampaignCreateResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T.nilable(
                Sentdm::Models::Profiles::CampaignCreateResponse::Data::OrHash
              )
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            T.nilable(Sentdm::Models::Profiles::CampaignCreateResponse::Error)
          )
        end
        attr_reader :error
        ...
        sig do
          params(
            error:
              T.nilable(
                Sentdm::Models::Profiles::CampaignCreateResponse::Error::OrHash
              )
          ).void
        end
        attr_writer :error
        ...
        sig do
          returns(
            T.nilable(Sentdm::Models::Profiles::CampaignCreateResponse::Meta)
          )
        end
        attr_reader :meta
        ...
        sig do
          params(
            meta: Sentdm::Models::Profiles::CampaignCreateResponse::Meta::OrHash
          ).void
        end
        attr_writer :meta
        ...
        sig do
          params(
            ...
            meta:
              Sentdm::Models::Profiles::CampaignCreateResponse::Meta::OrHash,
            success: T::Boolean
          ...
          override.returns(
            {
              data:
                T.nilable(
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data
                ),
              error:
                T.nilable(
                  Sentdm::Models::Profiles::CampaignCreateResponse::Error
                ),
        ...
        class Data < Sentdm::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Sentdm::Models::Profiles::CampaignCreateResponse::Data::SharingStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Sentdm::Models::Profiles::CampaignCreateResponse::Data::Status::TaggedSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::UseCase
                ]
              )
            )
          end
          ...
          sig do
            params(
              use_cases:
                T::Array[
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::UseCase::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              ...
              sharing_status:
                T.nilable(
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::SharingStatus::OrSymbol
                ),
              status:
                T.nilable(
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::Status::OrSymbol
                ),
          ...
          module SharingStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::SharingStatus
                )
              end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class UseCase < Sentdm::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::UseCase::MessagingUseCaseUs::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                messaging_use_case_us:
                  Sentdm::Models::Profiles::CampaignCreateResponse::Data::UseCase::MessagingUseCaseUs::OrSymbol
              ).void
            end
            ...
            module MessagingUseCaseUs
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Sentdm::Models::Profiles::CampaignCreateResponse::Data::UseCase::MessagingUseCaseUs
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
